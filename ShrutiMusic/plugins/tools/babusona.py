...
ifmember.statusin["administrator","creator"]:
        ifmessage.reply_to_message:
            reply_msg=awaitmessage.reply(f"{message.reply_to_message.from_user.mention} {random.choice(GALI)}")
else:
            reply_msg=awaitmessage.reply(random.choice(GALI))

awaitasyncio.sleep(60)
try:
            awaitreply_msg.delete()
awaitmessage.delete()
except:
            pass
else:
        reply_msg=awaitmessage.reply("**🚫 This command is only for admins!**\n\n💬 Try this in my DMs instead.")
